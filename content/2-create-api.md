...
- creating an endpoint to accept the the day of the week and the airport id, which calls the model and returns both the chances the flight will be delayed and the confidence percent of the prediction.
